...
const Popup: React.FC<customModelProps> = ({ visible, message, closeModal }) => {
  return (
    <Modal
      animationType='slide'
      transparent={true}
        ...
        <View style={styles.modalContent} >
          ...
          <View >
            ...
            <TouchableOpacity onPress={closeModal}>
              ...
              <Text style={{fontSize:responsiveFontSize(2),color:"#00aaf0",paddingHorizontal:responsiveHeight(2.8),marginTop:responsiveHeight(1.2),paddingVertical:responsiveHeight(0.5),borderRadius:responsiveHeight(5)}}>OK</Text>
              </View>
